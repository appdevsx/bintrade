            ...
            <div className="custom-container">
                <div className="section-header-wrapper grid grid-cols-1 md:grid-cols-6 mb-10">
                    <div className="section-header col-span-3">
                        ...
                        <h2 className="section-title text-4xl font-medium capitalize">{sectionHeader.sectionTitleLeft} <span className="font-extrabold text--base">{sectionHeader.sectionTitleMain}</span></h2>
                        <p className="mt-3.5 text-base">{sectionHeader.sectionDescription}</p>
                    </div>
                </div>
                <div className="app-item-wrapper grid grid-cols-2 gap-5">
                    {appItems.map(( appItem, index ) => {
                        return (
                            <div className={styles.appItem} key={index}>
                                <div className="app-content w-4/6">
                                ...
                                <div className="app-thumb absolute bottom-0 right-10">
